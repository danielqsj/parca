...
import {LabelSet} from "../../profilestore/v1alpha1/profilestore_pb";
import {Function, Line, Location, Mapping} from "../../metastore/v1alpha1/metastore_pb";
...
export enum QueryRequest_ReportType {
   ...
   *
   * @generated from enum value: REPORT_TYPE_FLAMEGRAPH_UNSPECIFIED = 0;
   */
