...
// @generated from file google/pprof/profile.proto (package perftools.profiles, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from message perftools.profiles.Profile
 */
export class Profile extends Message<Profile> {
   ...
   *
   * @generated from field: repeated perftools.profiles.ValueType sample_type = 1;
   */
   ...
   *
   * @generated from field: repeated perftools.profiles.Sample sample = 2;
   */
  sample: Sample[] = [];
   ...
   *
   * @generated from field: repeated perftools.profiles.Mapping mapping = 3;
   */
  mapping: Mapping[] = [];
   ...
   *
   * @generated from field: repeated perftools.profiles.Location location = 4;
   */
  location: Location[] = [];
   ...
   *
   * @generated from field: repeated perftools.profiles.Function function = 5;
   */
  function: Function[] = [];
   ...
   *
   * @generated from field: perftools.profiles.ValueType period_type = 11;
   */
  ...
  static readonly typeName = "perftools.profiles.Profile";
 ...
 *
 * @generated from message perftools.profiles.ValueType
 */
export class ValueType extends Message<ValueType> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.ValueType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message perftools.profiles.Sample
 */
export class Sample extends Message<Sample> {
   ...
   *
   * @generated from field: repeated perftools.profiles.Label label = 3;
   */
  label: Label[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.Sample";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message perftools.profiles.Label
 */
export class Label extends Message<Label> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.Label";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message perftools.profiles.Mapping
 */
export class Mapping extends Message<Mapping> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.Mapping";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message perftools.profiles.Location
 */
export class Location extends Message<Location> {
   ...
   *
   * @generated from field: repeated perftools.profiles.Line line = 4;
   */
  line: Line[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.Location";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
/**
 * @generated from message perftools.profiles.Line
 */
export class Line extends Message<Line> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.Line";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message perftools.profiles.Function
 */
export class Function extends Message<Function> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "perftools.profiles.Function";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
